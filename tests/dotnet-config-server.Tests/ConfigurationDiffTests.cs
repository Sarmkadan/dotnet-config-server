...
/// <summary>
/// Contains unit tests for <see cref="ConfigurationDiff"/> class that verify diff calculation and change tracking functionality.
/// </summary>
public sealed class ConfigurationDiffTests
{
	/// <summary>
	/// Creates an empty <see cref="ConfigurationDiff"/> instance with random identifiers for testing purposes.
	/// </summary>
	/// <returns>A new <see cref="ConfigurationDiff"/> instance with initialized properties.</returns>
	...
	/// <summary>
	/// Tests that adding a single entry with <see cref="ChangeType.Added"/> increments only the added counter.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that adding multiple entries with different change types correctly updates all counters.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that <see cref="ConfigurationDiff.GetChangesByType(ChangeType)"/> correctly filters changes by the specified type.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that <see cref="ConfigurationDiff.GetSummary()"/> returns a summary reflecting all accumulated change counts.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that validating an added entry with null <see cref="DiffEntry.NewValue"/> throws a <see cref="ValidationException"/>.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that validating a deleted entry with null <see cref="DiffEntry.OldValue"/> throws a <see cref="ValidationException"/>.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that validating a modified entry with both old and new values does not throw any exception.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that <see cref="DiffEntry.GetChangeDescription()"/> for a modified entry contains both old and new values.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests that <see cref="DiffEntry.GetChangeDescription()"/> for an added entry formats the description correctly.
	/// </summary>
	[Fact]

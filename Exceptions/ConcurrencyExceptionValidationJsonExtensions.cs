...
/// <summary>
/// Provides System.Text.Json serialization helpers for <see cref="ConcurrencyExceptionValidation"/>.
/// </summary>
public static class ConcurrencyExceptionValidationJsonExtensions
{
    ...
    /// <summary>
    /// Serializes a <see cref="ConcurrencyExceptionValidation"/> instance to a JSON string.
    /// </summary>
    ...
    /// <summary>
    /// Deserializes a JSON string to a <see cref="ConcurrencyExceptionValidation"/> instance.
    /// </summary>
    /// <param name="json">The JSON string to deserialize.</param>
    /// <returns>The deserialized <see cref="ConcurrencyExceptionValidation"/> instance, or null if the JSON represents a null value.</returns>
    ...
    /// <summary>
    /// Attempts to deserialize a JSON string to a <see cref="ConcurrencyExceptionValidation"/> instance.
    /// </summary>
    /// <param name="json">The JSON string to deserialize.</param>

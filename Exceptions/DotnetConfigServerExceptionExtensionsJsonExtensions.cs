...
/// </summary>
public static class DotnetConfigServerExceptionExtensionsJsonExtensions
{
	...
	/// <returns>The deserialized <see cref="DotnetConfigServerException"/> instance, or null.</returns>
	...
	/// Returns false and sets value to null if the JSON is invalid, deserialization fails, or the JSON is null/empty.
	/// </summary>
	/// <param name="json">The JSON string to deserialize.</param>
	...
	/// <returns>True if deserialization succeeded; otherwise, false.</returns>
	/// <exception cref="ArgumentNullException">Thrown when <paramref name="json"/> is null.</exception>
	public static bool TryFromJson(string json, out DotnetConfigServerException? value, out JsonException? error)
	{
		value = null;
		error = null;

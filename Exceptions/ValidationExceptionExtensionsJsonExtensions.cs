...
public static class ValidationExceptionExtensionsJsonExtensions
{
    ...
    /// <returns>The deserialized ValidationException instance, or null if JSON is empty or whitespace</returns>
    ...
    /// </summary>
    /// <param name="json">The JSON string to deserialize</param>
    /// <param name="value">Receives the deserialized ValidationException instance if successful</param>

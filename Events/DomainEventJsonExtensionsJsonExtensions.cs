...
/// <summary>
/// JSON serialization helpers for <see cref="DomainEvent"/>.
/// </summary>
public static class DomainEventJsonExtensionsJsonExtensions
{
    ...
    /// <returns>The deserialized <see cref="DomainEvent"/> instance; or null if deserialization fails.</returns>
    ...
    /// </summary>
    /// <param name="json">The JSON string to deserialize.</param>
    /// <param name="value">The deserialized <see cref="DomainEvent"/> instance; or null if deserialization fails.</param>
